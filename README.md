...
* wget package (at least version 1.17.9 that supports keypinning) used by the script itself, [e.g. 1.19.1 for ubuntu](https://security.ubuntu.com/ubuntu/pool/main/w/wget/wget_1.19.1-3ubuntu1.1_amd64.deb)
